        ...
        query.find { result in
            ...
            case .success:
                ...
                for obj in result.objects! {
                    ...
                    self.typeList?.append(TypeDto(objectId: objectId, name: typeName, make: typeMake, diecastBrand: typeDiecastBrand, category: typeCategory, imgUrls: typeImgUrls, brandId: "a"))
                }
                break
            case .failure(error: let error):
                print(error)
